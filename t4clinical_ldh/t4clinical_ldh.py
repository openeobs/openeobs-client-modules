...
class t4_clinical_ldh_patient_clerking(orm.Model):
    ...
    def complete(self, cr, uid, activity_id, context=None):
        ...
        review_pool.create_activity(cr,  SUPERUSER_ID, {'summary': clerking_activity.data_ref.patient_id.name+' Review', 'creator_id': activity_id}, {'patient_id': clerking_activity.data_ref.patient_id.id})
        return res
...
class t4_clinical_patient_placement(orm.Model):
    ...
    def complete(self, cr, uid, activity_id, context=None):
        ...
        clerking_pool.create_activity(cr,  SUPERUSER_ID, {'summary': placement_activity.data_ref.patient_id.name+' Clerking', 'creator_id': activity_id}, {'patient_id': placement_activity.data_ref.patient_id.id})
        return res